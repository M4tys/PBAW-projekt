...
--
-- Host: 127.0.0.1
-- Generation Time: Cze 04, 2024 at 04:54 AM
...
INSERT INTO `user` (`idUser`, `login`, `password`, `userName`, `creationDate`, `editDate`, `editedBy`) VALUES
(1, 'admin', '$2y$10$sEaYY2rpngzBRciJpnksueN.VzyIZb1r4Lev9N7wkXZL9rBPVc1pi', 'Administrator', '2024-05-17 23:26:22', NULL, NULL),
(2, 'user', '$2y$10$9YkihbpZ7OBUAPZsUBQoNOd/V7hP.TWYmkx1i.G0riyqGEja4s3IS', 'Użytkownik1', '2024-05-17 23:38:16', '2024-06-03 19:51:21', 1),
(3, 'dietician', '$2y$10$jTtROJ84NZ4DoiUrhq2P1eNZv0cB/oYebesgcx7Tf9wPJOFJ0lJ4q', 'Dietetyk', '2024-05-17 23:38:45', '2024-06-04 02:24:35', 1),
(14, 'anna.nowak', '$2y$10$wcaroLhVPJJJjU4fnmn4WuOMyMFu3xZUIWlqi6W14epVk3e3QgYS.', 'Anna Nowak', '2024-06-03 19:43:54', '2024-06-03 19:45:28', 1),
(15, 'maria.wojcik', '$2y$10$lJe9My/4XAj2gNNTh/QgY.PccRTuRheEAzJj9Nf2/3WaXRD1PDlKm', 'Maria Wojcik', '2024-06-03 19:44:19', NULL, NULL),
(16, 'piotr.wisniewski', '$2y$10$N.sB0jfz.wWCSHefBQpcKu7RAbuYi90xXy9u1nUdioV1f/a/DWK1a', 'Pioter', '2024-06-03 19:44:48', '2024-06-03 21:15:57', 17),
(17, 'Konrad', '$2y$10$fBFa2HrlMUJwhKnjKyaAqOUl4xZolFjrZ.RkIkAG4xE6QTSPz./my', 'Konrad', '2024-06-03 19:48:44', '2024-06-03 20:03:23', 1);
...
--
ALTER TABLE `dish`
  MODIFY `idDish` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
